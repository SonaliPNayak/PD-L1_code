...
% 
% stable_upper_PDL1 = PDL1(1:348,:);
% unstable_PDL1 = PDL1(348:546,:);
% stable_lower_PDL1 = PDL1(546:900,:);
%------------------------------------
%extraction of k zeb dataset
stable_upper_k_ZeB1 = k_ZeB1(1:440,:);
unstable_k_ZeB1 = k_ZeB1(440:572,:);
stable_lower_k_ZeB1 = k_ZeB1(572:900,:);
%----------------------------------------
% %extraction of slug dataset
% stable_upper_SLUG = SLUG(1:348,:);
% unstable_SLUG = SLUG(348:546,:);
% stable_lower_SLUG = SLUG(546:900,:);
%-------------------------------------------------
%extraction of mir200 dataset
stable_upper_miR200 = miR200(1:440,:);
unstable_miR200 = miR200(440:572,:);
stable_lower_miR200 = miR200(572:900,:);
%-------------------
% %extraction of mir200 dataset
% stable_upper_CDH1 = CDH1(1:348,:);
% unstable_CDH1 = CDH1(348:546,:);
